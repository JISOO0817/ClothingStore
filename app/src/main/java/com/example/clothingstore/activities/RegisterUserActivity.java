...
public class RegisterUserActivity extends AppCompatActivity {
    ...
    private EditText nameEt,phoneEt,addressEt,addressEt2,emailEt,passwordEt,cPasswordEt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent= new Intent(RegisterUserActivity.this, SearchAddressActivity.class);
    ...
    private void createAccount() {
        progressDialog.setMessage("계정 등록 중입니다...");
        progressDialog.show();
    ...
    private void saveFirebase() {
        progressDialog.setMessage("정보를 저장 중입니다...");
